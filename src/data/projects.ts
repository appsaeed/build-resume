...
export default [
    {
        ...
        description: `
        Built a Laravel SaaS app with user/admin dashboards and a custom real-time chat that facilitates seamless communication.|| 
        I successfully tackled chat integration challenges through rigorous testing and debugging, and implemented automated cron jobs to ensure smooth operation.|| 
        The application also empowers super admins with control over environment and settings.
        `,
        project_dates: 'September 2023 - January 2024'
    },
    {
        name: "NPM Packages",
        title: "NPM Packages",
        tags: ["Javascript package", "NPM Packages", "Vite Plugins"],
        github_link: "https://github.com/appsaeed/utilies#other-packages",
        description: `
        ...
        `,
        project_dates: 'January 2024 - April 2024'
    },
    {
        ...
        description: `Backend Node.js interactively! This platform offers YouTube/Udemy-like features for students & teachers: Watch lectures, build content & playlists, discuss concepts.|| track progress, leverage comments & likes. Replay abilities empower teachers. Go beyond videos: Implement full-stack with Custom Model Queries (toughest challenge, but aced it with Laravel knowledge!)`,
        project_dates: 'March 2024 - April 2024'
    },
    {
        name: "Auxonic",
        ...
        project_dates: "June 2023 - August 2023"
    },
